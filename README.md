## What this does?
This repo along with https://github.com/rajeshchandran007/gitops-k8s-manifests-cd creates a Jenkins pipeline with GitOps to deploy code into a Kubernetes cluster. CI part is done via Jenkins and CD part via ArgoCD (GitOps).
